...
Route::middleware([GlobalMiddleware::class])->group(function () {
    ...
    Route::prefix('setting')->group(function () {
        ...
        Route::get('/app-his-kalkulasi/read', [AppHisKalkulasiController::class, 'read'])->name('app-his-kalkulasi.read');
        Route::resource('app-his-kalkulasi', AppHisKalkulasiController::class);
        Route::post('/app-his-kalkulasi/update/{id}', [AppHisKalkulasiController::class, 'update'])->name('app-his-kalkulasi.update');
    });
    ...
    Route::prefix('master-data')->group(function () {
        ...
        Route::prefix('opsisdis')->group(function () {
            Route::get('/cuacas/read', [RefEpCuacaController::class, 'read'])->name('cuacas.read');
            Route::resource('cuacas', RefEpCuacaController::class);
            Route::post('/cuacas/update/{id}', [RefEpCuacaController::class, 'update'])->name('cuacas.update');

            Route::get('/indikasis/read', [RefEpIndikasiController::class, 'read'])->name('indikasis.read');
            Route::resource('indikasis', RefEpIndikasiController::class);
            Route::post('/cuacas/update/{id}', [RefEpCuacaController::class, 'update'])->name('cuacas.update');

            Route::get('/kategoriggns/read', [RefEpKategoriGgnController::class, 'read'])->name('kategoriggns.read');
            Route::resource('kategoriggns', RefEpKategoriGgnController::class);
            Route::post('/cuacas/update/{id}', [RefEpCuacaController::class, 'update'])->name('cuacas.update');

            Route::get('/penyebabggns/read', [RefEpPenyebabGgnController::class, 'read'])->name('penyebabggns.read');
            Route::resource('penyebabggns', RefEpPenyebabGgnController::class);
            Route::post('/cuacas/update/{id}', [RefEpCuacaController::class, 'update'])->name('cuacas.update');

            Route::get('/status-proteksis/read', [RefEpStatusProteksiController::class, 'read'])->name('status-proteksis.read');
            Route::resource('status-proteksis', RefEpStatusProteksiController::class);
            Route::post('/cuacas/update/{id}', [RefEpCuacaController::class, 'update'])->name('cuacas.update');
        });

        Route::prefix('fasop')->group(function () {
            Route::get('/scd-ref-sistem-scadas/read', [ScdRefSistemScadaController::class, 'read'])->name('scd-ref-sistem-scadas.read');
            Route::resource('scd-ref-sistem-scadas', ScdRefSistemScadaController::class);
            Route::post('/scd-ref-sistem-scadas/{id}', [ScdRefSistemScadaController::class, 'update'])->name('scd-ref-sistem-scadas.update');

            Route::get('/ref-target-kinerjas/read', [RefTargetKinerjaController::class, 'read'])->name('ref-target-kinerjas.read');
            Route::resource('ref-target-kinerjas', RefTargetKinerjaController::class);
            Route::post('/ref-target-kinerjas/{id}', [RefTargetKinerjaController::class, 'update'])->name('ref-target-kinerjas.update');
        });
    });
    ...
    Route::prefix('fasop')->group(function () {
        Route::prefix('realtime')->group(function () {
            ...
            Route::get('/meter-stations', [MeterStationController::class, 'index'])->name('fasop.realtime.meter-stations.index');
            Route::get('/meter-stations/read', [MeterStationController::class, 'read'])->name('fasop.realtime.meter-stations.read');
