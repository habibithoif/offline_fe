...
@push('scripts')
    <script>
        ...
        function deleteData(id) {
            ...
            Swal.fire({
                title: 'Warning!',
                text: `Are you sure you want to delete this data: ${selectedData.point_number}?`,
                icon: 'warning',
        ...
        loadData = function() {
            ...
            $("#jqxGrid").jqxGrid({
                ...
                columns: [
                    { text: 'Jenis Point', datafield: 'pointtype_name'},
                    { text: 'Station', datafield: 'station_name'},
                    { text: 'Bay', datafield: 'bay'},
                    { text: 'Point Number', datafield: 'point_number'},
                    { text: 'B1 Name', datafield: 'path1'},
                    { text: 'B2 Name', datafield: 'path2'},
                    { text: 'B3 Name', datafield: 'path3'},
                    { text: 'Element', datafield: 'path4'},
                    { text: 'Info', datafield: 'path5'},
                    { text: 'Kelompok', datafield: 'point_type'},
                    // { text: 'Hitung Kerja', datafield: 'name'},
                    { text: 'Capture Telemetering', datafield: 'capture_telemetring'},
                    { text: 'ACK', datafield: 'ack'},
                    { text: 'Keterangan', datafield: 'keterangan_point'},
                    { text: 'Zona', datafield: 'zona'},
                    { 
                        text: 'Dibuat', 
