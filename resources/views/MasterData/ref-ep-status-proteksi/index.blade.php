...
@push('scripts')
    <script>
        ...
        var statusProteksis = []; // Store statusProteksis data for easy access
        ...
        function detailData(id) {
            var selectedData = statusProteksis.find(function(item) {
                return item.id == id;
            });
            ...
            if (selectedData) {
                ...
                console.error('StatusProteksi item not found');
            }
        }
        ...
        function deleteData(id) {
            ...
            if (!selectedData) {
                alert('StatusProteksi not found');
                return;
            }
        ...
        function tambahData() {
            ...
            $('#modal-data-title').text('Tambah StatusProteksi Baru');
            urlAction = baseUrl;
            actionMethod = 'POST';
            toggleForm('#form-data', true);
        ...
        loadData = function() {
            ...
            var source = {
                ...
                url: '{{ route("status-proteksis.read") }}',
                cache: false,
                root: 'Rows',
                beforeprocessing: function(data) {
                    statusProteksis = data.data.Rows; // Store status-proteksis data
