                            ...
                            <div class="card-body card-body-filter">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Tahun</label>
                                            <select class="form-control form-control-sm select2" id="filterTahun" style="width: 100%;" data-placeholder="--Pilih Tahun--">
          ...
          <div class="modal-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control form-control-sm select2" style="width: 100%;" data-placeholder="--Pilih Tipe Point--" name="id_pointtype" id="id_pointtype" required>
    ...
    <script>
        ...
        loadData = function() {
            ...
            var source = {
                ...
                url: '{{ route("masterdata-fasop-target-bulanan.read") }}',
                cache: false,
                root: 'Rows',
        ...
        $(document).ready(function() {
            ...
            // Populate the filterTahun dropdown with the current year and the previous 5 years
