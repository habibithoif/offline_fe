                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <select class="form-control form-control-sm select2" id="filterTegangan">
                                                    <option value="">-- All Tegangan --</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-6">
                    <label for="point_type_id">Kelompok</label>
                    <select class="form-control form-control-sm select2" style="width: 100%;" data-placeholder="--Pilih Kelompok--" name="point_type_id" id="point_type_id" required>
                        <option value=""></option>
                ...
                <div class="form-group col-6">
                    <label for="path4name">Element</label>
                    <input type="text" class="form-control form-control-sm" name="path4name" id="path4name" required>
                </div>
                <div class="form-group col-6">
                    <label for="informasi">Informasi</label>
                    <input type="text" class="form-control form-control-sm" name="informasi" id="informasi">
                </div>
    ...
    <script>
        ...
        function detailData(id) {
            ...
            if (selectedData) {
                ...
                $('#id_region').val(selectedData.id_region).trigger('change');
                $('#point_number').val(selectedData.point_number);
                $('#point_type_id').val(selectedData.point_type_id).trigger('change');
                $('#path1name').val(selectedData.path1name);
                $('#path2name').val(selectedData.path2name);
                $('#path3name').val(selectedData.path3name);
                $('#path4name').val(selectedData.path4name);
                $('#informasi').val(selectedData.informasi);
        ...
        function deleteData(id) {
            ...
            Swal.fire({
                title: 'Warning!',
                text: `Apakah Anda yakin ingin menghapus data ini: ${selectedData.point_number}?`,
                icon: 'warning',
        ...
        function tambahData() {
            ...
            $('#modal-data-title').text('Tambah Fasop-Telemetering Baru');
            urlAction = baseUrl;
            actionMethod = 'POST';
            toggleForm('#form-data', true);
        ...
        $(document).ready(function() {
            ...
            $('#downloadButton').on('click', async function() {
                ...
                // Header custom
                var headers = ["Regional", "Point Number", "Kelompok", "B1 Name","B2 Name","B3 Name","Element","Informasi","Hitung Kinerja","Status"];
            ...
            $('#applyFilters').on('click', function () {
                ...
                if (filterHitungKinerja !== '') {
                    ...
                    // Default to 0 (false) if no value is selected
                    var defaultFilterGroup = new $.jqx.filter();
                    var defaultFilter = defaultFilterGroup.createfilter(
                        'booleanfilter', 
                        false, // Default to false (0)
                        'EQUAL'
                    );
                    defaultFilterGroup.addfilter(0, defaultFilter);
                    $("#jqxGrid").jqxGrid('addfilter', 'hitung_kinerja', defaultFilterGroup);
                }
            ...
            $('#form-data').validate({
                ...
                messages: {
                    ...
                    point_number: { required: "Kolom Point Number wajib diisi." },
