            ...
            <div class="col-md-12">
                ...
                <div class="card shadow-sm rounded">
                    ...
                    <div class="card-body p-3">
                        ...
                        <hr>
                        <!-- Search:<input type="text" id="searchInput" placeholder="Search..." style="margin-bottom:10px; width:200px;"> -->
...
@push('scripts')
    <script>
        ...
        //         let containsFilter = filterGroup.createfilter('stringfilter', value, 'contains');

        //         // Ulangi untuk semua kolom yg mau dicari
        //         ['nama', 'email', 'alamat'].forEach(col => {
        //             let fg = new $.jqx.filter();
        //             fg.addfilter(filter_or_operator, containsFilter);
        //             $("#jqxGrid").jqxGrid('addfilter', col, fg);
        //         });
