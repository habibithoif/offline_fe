    ...
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="card shadow-sm rounded">
                    <div class="card-header bg-info text-white">
                        <h3 class="card-title mb-0">KINERJA - REMOTE CONTROL</h3>
                        <div class="card-tools">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow-sm rounded">
                    <div class="card-header bg-info text-white">
                        <h3 class="card-title mb-0">DETAIL KINERJA - REMOTE CONTROL</h3>
                        <div class="card-tools">
    ...
    <script>
        ...
        function initializeGrid(filterParams = {}) {
            ...
            var source = {
                ...
                url: '{{ route("fasop.kinerja.remote-control.read") }}',
                cache: false,
                data: filterParams,
                root: 'Rows',
