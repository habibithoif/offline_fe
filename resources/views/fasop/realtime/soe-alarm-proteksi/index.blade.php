            ...
            <div class="col-md-12">
                <div class="card shadow-sm rounded">
                    <div class="card-header bg-info text-white">
                        <h3 class="card-title mb-0">HISTORI - SOE & Alarm Proteksi</h3>
                        <div class="card-tools">
...
@push('scripts')
    <script>
        ...
        function initializeGrid(filterParams = {}) {
            ...
            $("#jqxGrid").jqxGrid({
                ...
                columns: [
                    ...
                    { text: 'TAG', datafield: 'tag', width: 150 },
                    { text: 'Priority', datafield: 'priority', width: 150 },
                    { text: 'Operator', datafield: 'operator', width: 150 },
                    { text: 'Description', datafield: 'description', width: 150 },
                    { text: 'Source', datafield: 'source', width: 150 },
                    { text: 'Message Class', datafield: 'message_class', width: 150 },
                    // { text: 'AOC', datafield: 'aoc', width: 200 },
        ...
        $('#downloadButton').on('click', function() {
            exportGridAll('#jqxGrid','histori-soe-alarm-proteksi','csv');
        });
