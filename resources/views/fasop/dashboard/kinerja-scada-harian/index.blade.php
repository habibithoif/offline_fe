            ...
            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="month" class="form-control form-control-sm" id="filterBulanTahun" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow-sm rounded">
                            <div class="card-header bg-info text-white d-flex flex-column justify-content-center align-items-center">
                                <h3 class="card-title mb-1">AVA TM HARIAN</h3>
                                <h3 class="card-title ">BULAN : <span class="headerBulan1">-</span></h3>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm rounded">
                            <div class="card-header bg-info text-white d-flex flex-column justify-content-center align-items-center">
                                <h3 class="card-title mb-1">AVA TS HARIAN</h3>
                                <h3 class="card-title ">BULAN : <span class="headerBulan1">-</span></h3>
                            </div>
                            <div class="card-body p-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow-sm rounded">
                            <div class="card-header bg-info text-white d-flex flex-column justify-content-center align-items-center">
                                <h3 class="card-title mb-1">AVA RTU HARIAN</h3>
                                <h3 class="card-title ">BULAN : <span class="headerBulan1">-</span></h3>
                            </div>
                            <div class="card-body p-3">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm rounded">
                            <div class="card-header bg-info text-white d-flex flex-column justify-content-center align-items-center">
                                <h3 class="card-title mb-1">AVA MASTER HARIAN</h3>
                                <h3 class="card-title ">BULAN : <span class="headerBulan1">-</span></h3>
                            </div>
                            <div class="card-body p-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow-sm rounded">
                            <div class="card-header bg-info text-white d-flex flex-column justify-content-center align-items-center">
                                <h3 class="card-title mb-1">AVA RC HARIAN</h3>
                                <h3 class="card-title ">BULAN : <span class="headerBulan1">-</span></h3>
                            </div>
                            <div class="card-body p-3">
...
@push('scripts')
    <script>
        ...
        function loadCharts() {
            ...
            const filterBulanTahun = $('#filterBulanTahun').val();

            if (!filterBulanTahun) {
                alert('Please select a Bulan-Tahun!');
                return;
            }

            // Extract year and month from the Bulan-Tahun filter
            const [year, month] = filterBulanTahun.split('-');

            // Update the header text for both charts
            const months = [
                'Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni',
                'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'
            ];
            const monthName = months[parseInt(month, 10) - 1];
            $('#headerBulan1').text(`${monthName} ${year}`);

            // Calculate the number of days in the selected month
            const daysInMonth = new Date(year, month, 0).getDate();
            const categories = Array.from({ length: daysInMonth }, (_, i) => (i + 1).toString()); // Days 1 to daysInMonth
            
            // Dummy data for multiple regions
            const regionData = {
                'region1': Array.from({ length: daysInMonth }, () => Math.floor(Math.random() * 20) + 80), // Random data
                'region2': Array.from({ length: daysInMonth }, () => Math.floor(Math.random() * 20) + 70),
                'region3': Array.from({ length: daysInMonth }, () => Math.floor(Math.random() * 20) + 60)
            };
            ...
            Highcharts.chart('chart-ava-tm-harian', {
                ...
                title: {
                    text: `AVABILITY TM <br> ${monthName} ${year}`,
                    style: {
            ...
            Highcharts.chart('chart-ava-ts-harian', {
                ...
                title: {
                    text: `AVABILITY TS <br> ${monthName} ${year}`,
                    style: {
                        fontSize: '12px', // Set the font size
                        fontWeight: 'normal' // Remove bold styling
                    }
            ...
            Highcharts.chart('chart-ava-rtu-harian', {
                ...
                title: {
                    text: `AVABILITY RTU <br> ${monthName} ${year}`,
                    style: {
                        fontSize: '12px', // Set the font size
                        fontWeight: 'normal' // Remove bold styling
                    }
            ...
            Highcharts.chart('chart-ava-master-harian', {
                ...
                title: {
                    text: `AVABILITY MASTER <br> ${monthName} ${year}`,
                    style: {
                        fontSize: '12px', // Set the font size
                        fontWeight: 'normal' // Remove bold styling
                    }
            ...
            Highcharts.chart('chart-ava-rc-harian', {
                ...
                title: {
                    text: `AVABILITY RC <br> ${monthName} ${year}`,
                    style: {
                        fontSize: '12px', // Set the font size
                        fontWeight: 'normal' // Remove bold styling
                    }
        ...
        $(document).ready(function() {
            ...
            $('#filterBulanTahun').val(defaultDate);
