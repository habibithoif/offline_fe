            ...
            <div class="col-md-12">
                <div class="card shadow-sm rounded">
                    <div class="card-header bg-info text-white">
                        <h3 class="card-title mb-0">HISTORI - REMOTE CONTROL</h3>
                        <div class="card-tools">
...
@push('scripts')
    <script>
        ...
        function initializeGrid(filterParams = {}) {
            ...
            $("#jqxGrid").jqxGrid({
                ...
                columns: [
                    ...
                    { text: 'Status Mulai', datafield: 'status', width: 100 },
                    { text: 'Tanggal Mulai', datafield: 'rtu_datetime', width: 200 },
                    { text: 'Status Respon', datafield: 'status_2', width: 100 },
                    { text: 'Tanggal Respon', datafield: 'rtu_datetime_2', width: 200 },
        ...
        $('#downloadButton').on('click', function() {
            exportGridAll('#jqxGrid','histori-rc','csv');
        });
