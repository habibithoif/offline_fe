...
<?php $ii=$startpoint; while($row_data = mysqli_fetch_array($data))	 { ?>
		        ...
		        <td class="left"> 
<a href="jadwal_har_delete.php?hapus=<?php  echo $row_data['id_pek']; ?>" OnClick="return confirm('Are you sure? This will remove data with ID PEK <?php  echo $row_data['id_pek']; ?> forever !!!')" > 
