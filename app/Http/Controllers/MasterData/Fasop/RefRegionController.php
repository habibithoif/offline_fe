...
class RefRegionController extends Controller
{
    ...
    {
        return view('MasterData.fasop.ref-region.index', ['data' => $this->data]);
    }

    public function read(Request $request)
    {
        $payload = $request->all();
        $response = $this->apiRequest('get', 'ref-region', $payload);
    ...
    public function store(Request $request) {
        ...
        $response = $this->apiRequest('post', 'ref-region', $data);
    ...
    public function update(Request $request) {
        ...
        $response = $this->apiRequest('put', 'ref-region/'.$request->id, $data);
        return $response;
    }
    ...
    public function destroy($id) {
        ...
        $response = $this->apiRequest('delete', 'ref-region/'.$id, $data);
