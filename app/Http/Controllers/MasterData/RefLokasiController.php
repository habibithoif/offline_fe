...
class RefLokasiController extends Controller
{
    ...
    {
        return view('MasterData.ref-lokasi.index', ['data' => $this->data]);
    }

    public function read(Request $request)
    {
        $payload = $request->all();
        $response = $this->apiRequest('get', 'ref-lokasis', $payload);
    ...
    public function store(Request $request) {
        ...
        $response = $this->apiRequest('post', 'ref-lokasis', $data);
    ...
    public function update(Request $request) {
        ...
        $response = $this->apiRequest('put', 'ref-lokasis/'.$request->id, $data);
        return $response;
    }
    ...
    public function destroy($id) {
        ...
        $response = $this->apiRequest('delete', 'ref-lokasis/'.$id, $data);
