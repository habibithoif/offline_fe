...
class RefEpPenyebabGgnController extends Controller
{
    ...
    {
        return view('MasterData.ref-ep-penyebabggn.index', ['data' => $this->data]);
    }

    public function read(Request $request)
    {
        $payload = $request->all();
        $response = $this->apiRequest('get', 'ref-ep-penyebabggns', $payload);
    ...
    public function store(Request $request) {
        ...
        $response = $this->apiRequest('post', 'ref-ep-penyebabggns', $data);
    ...
    public function update(Request $request) {
        ...
        $response = $this->apiRequest('put', 'ref-ep-penyebabggns/'.$request->id, $data);
        return $response;
    }
    ...
    public function destroy($id) {
        ...
        $response = $this->apiRequest('delete', 'ref-ep-penyebabggns/'.$id, $data);
